...
class ClickHouseConfig:
    ...
    def port(self) -> int:
        ...
        """
        return Config.CLICKHOUSE_PORT

    @property
    def username(self) -> str:
        """Get the ClickHouse username."""
        return Config.CLICKHOUSE_USER
    ...
    def database(self) -> Optional[str]:
        ...
        return Config.CLICKHOUSE_DATABASE
    ...
    def secure(self) -> bool:
        ...
        Default: True
        """
        return Config.CLICKHOUSE_SECURE
    ...
    def verify(self) -> bool:
        ...
        Default: True
        """
        return Config.CLICKHOUSE_VERIFY
    ...
    def connect_timeout(self) -> int:
        ...
        Default: 30
        """
        return Config.CLICKHOUSE_CONNECT_TIMEOUT
    ...
    def send_receive_timeout(self) -> int:
        ...
        """
        return Config.CLICKHOUSE_SEND_RECEIVE_TIMEOUT
    ...
    def _validate_required_vars(self) -> None:
        """Validate that all required environment variables in Config are set.
