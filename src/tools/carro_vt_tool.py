        ...
        try:
            ...
            if opcion_entrega != "Entrega Inmediata":
                ...
                if opcion_entrega == "Retiro en Tienda":
                    ...
                    tiendas_url = f"https://b2b-api.implementos.cl/api/logistica/tiendasretiroomni?usuario={rut_normalizado}&ov=&vendedor={nombre_usuario_vendedor}"
            ...
            carro_entity["vendedor"] = nombre_usuario_vendedor.lower()
